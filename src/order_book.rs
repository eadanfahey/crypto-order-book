...
impl OrderBook {
    ...
    pub fn update_ask_level(&mut self, price: u64, quantity: u64) {
        if quantity == 0 {
    ...
    pub fn update_bid_level(&mut self, price: u64, quantity: u64) {
        if quantity == 0 {
...
// use crate::binance::{self, spot_old::PriceLevel};
// use serde::{Deserialize, Serialize};
// use std::collections::BTreeMap;
...
//     pub fn new(init: binance::spot_old::OrderBook) -> Self {
...
//     pub fn update(&mut self, diff: &binance::spot_old::OrderBookDiff) {
